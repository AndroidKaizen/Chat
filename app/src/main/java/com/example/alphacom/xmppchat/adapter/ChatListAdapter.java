package com.example.alphacom.xmppchat.adapter;
...
import com.example.alphacom.xmppchat.utils.OpenfileFunction;
...
public class ChatListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		useridView.setText(listMsg.get(position).getFrom());
